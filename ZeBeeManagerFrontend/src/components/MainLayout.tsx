    ...
    return (
        <div className="relative flex flex-col min-h-screen bg-black overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                ...
                <div className="absolute top-[5%] left-[5%] w-[400px] h-[400px] bg-[#00F5FF]/25 rounded-full filter blur-[120px]" style={{animation: 'smoothRandomFloat1 45s ease-in-out infinite'}}></div>
                ...
                <div className="absolute bottom-[5%] left-[8%] w-[450px] h-[350px] bg-[#00F5FF]/22 rounded-full filter blur-[130px]" style={{animation: 'smoothRandomFloat4 41s ease-in-out infinite'}}></div>
                ...
                <div className="absolute left-[25%] w-[1px] h-[100vh] bg-gradient-to-t from-transparent via-[#00F5FF]/6 to-transparent opacity-25" style={{animation: 'lightBeamRise 70s linear infinite'}}></div>
                ...
                {/* Movimento adicional no centro */}
                 ...
                 <div className="absolute top-[25%] right-[30%] w-[250px] h-[250px] bg-[#00F5FF]/10 rounded-full filter blur-[80px]" style={{animation: 'smoothRandomFloat2 63s ease-in-out infinite'}}></div>
                 ...
                 <div className="absolute bottom-[3%] right-[1%] w-[280px] h-[280px] bg-[#00F5FF]/15 rounded-full filter blur-[85px]" style={{animation: 'smoothRandomFloat4 44s ease-in-out infinite reverse'}}></div>
            </div>
